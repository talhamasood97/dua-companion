...
export const DUAS: Dua[] = [
  ...
  },
  {
    ...
    authenticity_grade: "SAHIH",
    category: "worship",
    emotion_tags: ["stressed", "afraid", "stressed"],
  ...
  },
  {
    ...
    authenticity_grade: "QURAN",
    category: "worship",
    emotion_tags: ["afraid", "stressed", "stressed", "hopeful"],
  ...
  },
  {
    ...
    authenticity_grade: "HASAN",
    category: "daily-life",
    emotion_tags: ["stressed", "stressed", "sad"],
  ...
  },
  {
    ...
    title: "Dua for Finding a Job and Employment",
    arabic_text:
      "اللَّهُمَّ إِنِّي أَسْأَلُكَ مِنْ فَضْلِكَ وَرَحْمَتِكَ فَإِنَّهُ لا يَمْلِكُهَا إِلاَّ أَنْتَ",
    transliteration:
      "Allahumma inni as'aluka min fadlika wa rahmatika fa innahu la yamlikusha illa ant",
    translation:
      "O Allah, I ask You for Your bounty and Your mercy, for indeed no one possesses them except You.",
    source_book: "Al-Mu'jam al-Awsat",
    hadith_number: "Tabrani",
    authenticity_grade: "HASAN",
    category: "daily-life",
    emotion_tags: ["hopeful", "stressed"],
    situation_tags: ["job", "employment", "work", "career", "rizq", "income"],
    scholar_verified: true,
    featured: false,
    daily_dua_eligible: true,
  },
  ...
  },
  {
    ...
    authenticity_grade: "SAHIH",
    category: "daily-life",
    emotion_tags: ["stressed", "sad", "stressed"],
  ...
  },
  {
    ...
    authenticity_grade: "QURAN",
    category: "daily-life",
    emotion_tags: ["stressed", "stressed", "seeking-forgiveness"],
  ...
  },
  {
    ...
    authenticity_grade: "SAHIH",
    category: "daily-life",
    emotion_tags: ["sad", "stressed", "stressed"],
  ...
  },
  {
    ...
    title: "Dua for Success and Blessing in Business",
    arabic_text:
      "اللَّهُمَّ بَارِكْ لَنَا فِي صَفَقَاتِنَا",
    transliteration:
      "Allahumma barik lana fi safaqatina",
    translation:
      "O Allah, bless us in our transactions.",
    source_book: "Sunan al-Tirmidhi",
    hadith_number: "1258",
    authenticity_grade: "HASAN",
    category: "daily-life",
    emotion_tags: ["hopeful", "grateful"],
    situation_tags: ["business", "trade", "income", "work", "blessing", "financial"],
    scholar_verified: true,
    featured: false,
    daily_dua_eligible: true,
  },
  ...
  },
  {
    ...
    authenticity_grade: "SAHIH",
    category: "daily-life",
    emotion_tags: ["afraid", "stressed", "stressed"],
  ...
  },
  {
    ...
    title: "Dua for Jumu'ah – Friday Prayer Acceptance",
    arabic_text:
    ...
    transliteration:
      "Allahumma innaka ta'lamu sirri wa 'alaniyati faqbal ma'dhirati, wa ta'lamu hajati fa a'tini su'li, wa ta'lamu ma fi nafsi faghfir li dhunubi",
    translation:
      "O Allah, You know my secrets and my public actions; accept my excuse. You know my needs; grant me what I ask. You know what is in my soul; forgive me my sins.",
    source_book: "Al-Adhkar",
    hadith_number: "Imam al-Nawawi",
    authenticity_grade: "HASAN",
    category: "worship",
    emotion_tags: ["seeking-forgiveness", "hopeful"],
    situation_tags: ["jummah", "friday", "prayer", "weekly"],
    scholar_verified: true,
    featured: false,
    daily_dua_eligible: false,
  },
  ...
  {
    id: 146,
    slug: "dua-for-settling-debt",
    title: "Dua for Settling Debt and Financial Relief",
    arabic_text:
      "اللَّهُمَّ إِنِّي أَعُوذُ بِكَ مِنَ الْهَمِّ وَالْحَزَنِ وَأَعُوذُ بِكَ مِنَ الْعَجْزِ وَالْكَسَلِ وَأَعُوذُ بِكَ مِنَ الْجُبْنِ وَالْبُخْلِ وَأَعُوذُ بِكَ مِنْ غَلَبَةِ الدَّيْنِ وَقَهْرِ الرِّجَالِ",
    transliteration:
      "Allahumma inni a'udhu bika minal-hammi wal-hazani wa a'udhu bika minal-'ajzi wal-kasali wa a'udhu bika minal-jubni wal-bukhli wa a'udhu bika min ghalbatid-dayni wa qahrir-rijal",
    translation:
      "O Allah, I seek refuge in You from worry and grief; I seek refuge in You from incapacity and laziness; I seek refuge in You from cowardice and miserliness; and I seek refuge in You from being overwhelmed by debt and overpowered by men.",
    source_book: "Sahih al-Bukhari",
    hadith_number: "6369",
    authenticity_grade: "SAHIH",
    category: "daily-life",
    emotion_tags: ["stressed", "stressed"],
    situation_tags: ["debt", "financial", "money", "hardship", "morning", "daily"],
    scholar_verified: true,
    featured: false,
    daily_dua_eligible: true,
  },
